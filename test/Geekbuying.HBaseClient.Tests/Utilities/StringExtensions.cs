...
namespace Geekbuying.HBaseClient.Tests.Utilities
{
    internal static class StringExtensions
    {
        ...
        internal static bool ToBooleanIc(this string value)
        {
            ...
            if (thisValue.EqualsOi("1") || thisValue.EqualsOi("-1") || thisValue.EqualsOi("yes")) return true;
        ...
        internal static DateTime ToDateTimeLocalEnu(this string value)
        {
            ...
            DateTime result;
            if (DateTime.TryParse(value, specificCulture, DateTimeStyles.AllowWhiteSpaces | DateTimeStyles.AssumeLocal,
                out result)) return result;
            throw new InvalidOperationException("Unable to convert {0} to DateTime.".FormatIc(value));
        }
        ...
        internal static object ToType(this string value, Type type)
        {
            ...
            if (type == typeof(bool)) return value.ToBooleanIc();
            if (type == typeof(long)) return value.ToInt64Ic();
        ...
        internal static string TrimNullOrEmptyToDefault(this string value, string defaultValue)
        {
            ...
            if (str.Length == 0) str = defaultValue;
            return str;
        }
