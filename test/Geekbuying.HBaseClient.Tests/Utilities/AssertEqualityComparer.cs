...
namespace Geekbuying.HBaseClient.Tests.Utilities
{
    ...
    internal sealed class AssertEqualityComparer<T> : IEqualityComparer<T>
    {
        ...
        public bool Equals(T x, T y)
        {
            ...
            if (comparable1 != null) return comparable1.CompareTo(y) == 0;

            // Implements IComparable?
            var comparable2 = x as IComparable;
            if (comparable2 != null) return comparable2.CompareTo(y) == 0;
            ...
            if (enumerableX != null && enumerableY != null)
            {
                ...
                while (true)
                {
                    ...
                    if (!InnerComparer.Equals(enumeratorX.Current, enumeratorY.Current)) return false;
                }
            }
