...
namespace Geekbuying.HBaseClient.Filters
{
    ...
    /// </summary>
    /// <remarks>
    /// Use of this filter overrides any time range/time stamp options specified using Get.setTimeRange(long, long),
    ...
    public class TimestampsFilter : Filter
    {
        ...
        /// The timestamps.
        /// </value>
        public IEnumerable<long> Timestamps => _timestamps.ToList();
        ...
        public override string ToEncodedString()
        {
            ...
            return string.Format(CultureInfo.InvariantCulture, filterPattern,
                ToCsvStringWithDoubleQuotedValues(_timestamps));
        }
        ...
        internal string ToCsvStringWithDoubleQuotedValues(IEnumerable<long> values)
        {
            ...
            foreach (var v in values) working.AppendFormat(@"""{0}"",", v);
