...
namespace Geekbuying.HBaseClient.Filters
{
    ...
    /// </summary>
    /// <remarks>
    /// Note that this filter cannot guarantee that the number of results returned to a client are less than or equal to page
    /// size. This is because
    /// the filter is applied separately on different region servers. It does however optimize the scan of individual HRegions
    /// by making sure that
