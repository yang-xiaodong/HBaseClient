...
{
    /// <summary>
    /// A filter for adding inter-column timestamp matching Only cells with a correspondingly timestamped entry in the target
    ...
    public class DependentColumnFilter : CompareFilter
    {
        ...
        public byte[] Family => (byte[]) _family.Clone();
        ...
        /// </value>
        [SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays")]
        public byte[] Qualifier => (byte[]) _qualifier.Clone();
