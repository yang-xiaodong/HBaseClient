...
namespace Geekbuying.HBaseClient.Internal.Helpers
{
    internal static class TaskHelpers
    {
        ...
        internal static async Task<T> WithTimeout<T>(this Task<T> task, TimeSpan timeout, string errorMessage,
        ...
        internal static async Task WithTimeout(this Task task, TimeSpan timeout, string errorMessage,
            CancellationToken token)
        {
            using (var cts = CreateLinkedCancellationTokenSource(token))
            {
