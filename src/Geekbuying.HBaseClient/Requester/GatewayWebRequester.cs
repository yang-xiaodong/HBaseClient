...
using Geekbuying.HBaseClient.Internal.Helpers;

namespace Geekbuying.HBaseClient.Requester
{
    /// <summary>
    /// </summary>
    public sealed class GatewayWebRequester : IWebRequester, IDisposable
    {
        ...
        /// <returns></returns>
        public Response IssueWebRequest(string endpoint, string query, string method, Stream input,
