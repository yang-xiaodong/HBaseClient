...
namespace Geekbuying.HBaseClient
{
    ...
    /// </code>
    /// Scan Requests are stateful. Please provide RequestOption for every scan requests to specify the request is sent to
    /// which REST server.
    /// In Gateway mode, RequestOption.AlternativeEndpoint need to be set to "hbaserest0/","hbaserest1/","hbaserest2/"...etc.
    /// In VNET mode,  RequestOption.AlternativeEndpoint need to be set to "/" and RequestOption.AlternativeHost need to be set
    /// or use loadbalancer.
    /// </remarks>
    public interface IHBaseClient
    {
        ...
        /// <summary>
        /// Gets the cells asynchronously. Getting column value by columnName and getting multi-versions only work in VNET mode
        /// currently.
        /// </summary>
        ...
        /// <returns></returns>
        Task<CellSet> GetCellsAsync(string tableName, string rowKey, string columnName = null,
        ...
        /// <returns>
        /// </returns>
        Task<Version> GetVersionAsync(RequestOptions options = null);
        ...
        Task<bool> CheckAndDeleteAsync(string table, Cell cellToCheck, CellSet.Row row = null,
            RequestOptions options = null);


        Task<IEnumerable<CellSet>> StatelessScannerAsync(string tableName, string optionalRowPrefix = null,
