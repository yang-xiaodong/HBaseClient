...
using Geekbuying.HBaseClient.Requester;
...
namespace Geekbuying.HBaseClient
{
    ...
    public sealed class HBaseClient : IHBaseClient, IDisposable
    {
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope", Justification =
            "_requester disposed of in Dispose() if it is an IDisposable")]
        ...
        /// </summary>
        /// <remarks>
        /// Since this class is <see langword="sealed" />, the standard
        /// <see
        ///     cref="IDisposable.Dispose" />
        /// pattern is not required. Also,
        /// <see
        ///     cref="GC.SuppressFinalize" />
        /// is not needed.
        /// </remarks>
        public void Dispose()
        {
        ...
        /// The resulting ScannerInformation can be used to read query the CellSets returned by this scanner in the
        /// #ScannerGetNext/Async method.
        /// </summary>
            ...
            RequestOptions options)
        {
            ...
            return await options.RetryPolicy.ExecuteAsync(() =>
                CreateScannerAsyncInternal(tableName, scannerSettings, options));
        }
        ...
        public async Task DeleteCellsAsync(string tableName, string rowKey, string columnFamily, long timestamp,
            RequestOptions options = null)
        {
            ...
            await optionToUse.RetryPolicy.ExecuteAsync(() => DeleteCellsAsyncInternal(tableName,
                string.Format(CultureInfo.InvariantCulture, RowKeyColumnFamilyTimeStampFormat, rowKey, columnFamily,
                    timestamp), optionToUse));
        }
        ...
        /// <returns>
        /// returns true if the table was created, false if the table already exists. In case of any other error it throws
        /// a WebException.
        /// </returns>
        ...
        /// <returns></returns>
        public async Task<CellSet> GetCellsAsync(string tableName, string rowKey, string columnName = null,
            string numOfVersions = null, RequestOptions options = null)
        {
            tableName.ArgumentNotNullNorEmpty("tableName");
            ...
            if (columnName != null) endpoint += "/" + columnName;
            string query = null;
            if (numOfVersions != null) query = "v=" + numOfVersions;
        ...
        public async Task<StorageClusterStatus> GetStorageClusterStatusAsync(RequestOptions options = null)
        {
            var optionToUse = options ?? _globalRequestOptions;
            return await optionToUse.RetryPolicy.ExecuteAsync(() =>
                GetRequestAndDeserializeAsync<StorageClusterStatus>("/status/cluster", null, optionToUse));
        }
        ...
        public async Task<TableInfo> GetTableInfoAsync(string table, RequestOptions options = null)
        {
            ...
            var optionToUse = options ?? _globalRequestOptions;
            return await optionToUse.RetryPolicy.ExecuteAsync(() =>
                GetRequestAndDeserializeAsync<TableInfo>(table + "/regions", null, optionToUse));
        }
        ...
        public async Task<TableSchema> GetTableSchemaAsync(string table, RequestOptions options = null)
        {
            ...
            var optionToUse = options ?? _globalRequestOptions;
            return await optionToUse.RetryPolicy.ExecuteAsync(() =>
                GetRequestAndDeserializeAsync<TableSchema>(table + "/schema", null, optionToUse));
        }
        ...
        /// <returns>
        /// </returns>
        public async Task<Version> GetVersionAsync(RequestOptions options = null)
        {
            var optionToUse = options ?? _globalRequestOptions;
            return await optionToUse.RetryPolicy.ExecuteAsync(() =>
                GetRequestAndDeserializeAsync<Version>("version", null, optionToUse));
        }
        ...
        public async Task<TableList> ListTablesAsync(RequestOptions options = null)
        {
            var optionToUse = options ?? _globalRequestOptions;
            return await optionToUse.RetryPolicy.ExecuteAsync(() =>
                GetRequestAndDeserializeAsync<TableList>("", null, optionToUse));
        }
        ...
        public async Task ModifyTableSchemaAsync(string table, TableSchema schema, RequestOptions options = null)
        {
            ...
            var optionToUse = options ?? _globalRequestOptions;
            await optionToUse.RetryPolicy.ExecuteAsync(() =>
                ModifyTableSchemaAsyncInternal(table, schema, optionToUse));
        }
        ...
        public async Task<bool> CheckAndPutAsync(string table, CellSet.Row row, Cell cellToCheck,
            RequestOptions options = null)
        {
            table.ArgumentNotNullNorEmpty("table");
            ...
            return await optionToUse.RetryPolicy.ExecuteAsync(() =>
                StoreCellsAsyncInternal(table, cellSet, optionToUse, Encoding.UTF8.GetString(row.key),
                    CheckAndPutQuery));
        }
        ...
        public async Task<bool> CheckAndDeleteAsync(string table, Cell cellToCheck, CellSet.Row rowToDelete = null,
            RequestOptions options = null)
        {
            table.ArgumentNotNullNorEmpty("table");
            ...
            RequestOptions options)
        {
            using (var response = await PostRequestAsync(tableName + "/scanner", scannerSettings, options))
            {
                ...
                var location = response.WebResponse.Headers.Get("Location");
        ...
        {
            var cells = new List<CellSet>();
            var reader = new BinaryReader(stream);
            while (true)
            {
                // read chunck length
                var lengthBytes = new byte[2];
                var readBytes = reader.Read(lengthBytes, 0, lengthBytes.Length);
                if (readBytes <= 0) break;
                var slengthBytes = new sbyte[2];
                Buffer.BlockCopy(lengthBytes, 0, slengthBytes, 0, lengthBytes.Length);
                var length = (short) (((slengthBytes[0] & 0xFF) << 8) | (slengthBytes[1] & 0xFF));
                var cellSet = new byte[length];
                var byteread = stream.Read(cellSet, 0, length);
                var sc = Serializer.Deserialize<CellSet>(new MemoryStream(cellSet, 0, byteread));
                cells.Add(sc);
            }
            ...
            RequestOptions options) where TReq : class
        {
            ...
            {
                if (request != null) Serializer.Serialize(input, request);
        ...
        private async Task<Response> PutRequestAsync<TReq>(string endpoint, string query, TReq request,
            RequestOptions options)
            where TReq : class
        {
            options.ArgumentNotNull("request options");
