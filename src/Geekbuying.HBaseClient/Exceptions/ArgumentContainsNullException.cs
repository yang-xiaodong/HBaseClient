...
namespace Geekbuying.HBaseClient.Exceptions
{
    /// <summary>
    /// The exception that is thrown when a collection containing a null reference is passed to a method that does not accept
    /// collections
    ...
    public sealed class ArgumentContainsNullException : ArgumentException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgumentContainsNullException" /> class with the name of the parameter
        /// that caused this
        /// exception.
        /// </summary>
        /// <param name="message">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgumentContainsNullException" /> class with a specified error message and
        /// the exception
        ...
        /// </param>
        public ArgumentContainsNullException(string message, Exception innerException) : this(null, message,
            innerException)
        {
        }

        /// <summary>
        /// Initializes an instance of the <see cref="ArgumentContainsNullException" /> class with a specified error message and
        /// the name of the
