...
namespace Geekbuying.HBaseClient.LoadBalancing
{
    public class IgnoreFailedEndpointsPolicy : IEndpointIgnorePolicy
    {
        ...
        public IgnoreFailedEndpointsPolicy(List<Uri> endpoints, TimeSpan failedEndpointExpiryInterval,
            IEndpointIgnorePolicy innerPolicy = null)
        {
        ...
        public IEndpointIgnorePolicy InnerPolicy => _innerPolicy;
        ...
        {
            if (!_endpoints.ContainsKey(endpoint)) return true;
